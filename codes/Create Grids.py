...
<html lang="en">
  ...
  <title>DSTL_Sattelite_Image_Object_Classification/createGrids.py at master · asmotiwale/DSTL_Sattelite_Image_Object_Classification</title>
  ...
  <link rel="web-socket" href="wss://live.github.com/_sockets/VjI6MjczMzA4MjQ2OmIwZmM1YjhiNGIzNmZhMWExZmRhZjM2MzE2ZWIzZmQ0YzkzYmM5YjA4ODdmMzc2MWYyYzc3N2U0M2JiNWNjYTc=--be69480dbd9d2cea9e463ef6acae72d800a1e13a">
  <meta name="pjax-timeout" content="1000">
  <link rel="sudo-modal" href="/sessions/sudo_modal">
  <meta name="request-id" content="C618:1190:449BBDD:7DEA451:5AEE3535" data-pjax-transient>
...
<meta name="analytics-location" content="/&lt;user-name&gt;/&lt;repo-name&gt;/blob/show" data-pjax-transient="true" />
  ...
  <meta class="js-ga-set" name="dimension1" content="Logged In">
    ...
    <meta name="js-proxy-site-detection-payload" content="">
  ...
  <meta name="octolytics-dimension-user_id" content="21133395" /><meta name="octolytics-dimension-user_login" content="asmotiwale" /><meta name="octolytics-dimension-repository_id" content="91845262" /><meta name="octolytics-dimension-repository_nwo" content="asmotiwale/DSTL_Sattelite_Image_Object_Classification" /><meta name="octolytics-dimension-repository_public" content="true" /><meta name="octolytics-dimension-repository_is_fork" content="false" /><meta name="octolytics-dimension-repository_network_root_id" content="91845262" /><meta name="octolytics-dimension-repository_network_root_nwo" content="asmotiwale/DSTL_Sattelite_Image_Object_Classification" /><meta name="octolytics-dimension-repository_explore_github_marketplace_ci_cta_shown" content="false" />
    ...
    <link rel="canonical" href="https://github.com/asmotiwale/DSTL_Sattelite_Image_Object_Classification/blob/master/code/createGrids.py" data-pjax-transient>
...
<header class="Header  f5" role="banner">
  ...
  <!-- '"` --><!-- </textarea></xmp> --></option></form><form class="js-site-search-form" data-scope-type="Repository" data-scope-id="91845262" data-scoped-search-url="/asmotiwale/DSTL_Sattelite_Image_Object_Classification/search" data-unscoped-search-url="/search" action="/asmotiwale/DSTL_Sattelite_Image_Object_Classification/search" accept-charset="UTF-8" method="get"><input name="utf8" type="hidden" value="&#x2713;" />
    <label class="form-control header-search-wrapper  js-chromeless-input-container">
          <a class="header-search-scope no-underline" href="/asmotiwale/DSTL_Sattelite_Image_Object_Classification/blob/master/code/createGrids.py">This repository</a>
      <input type="text"
...
<a class="dropdown-item" href="https://gist.github.com/" data-ga-click="Header, create new gist">
  ...
  <li class="dropdown js-menu-container">
    ...
    <details class="dropdown-details details-reset js-dropdown-details d-flex pl-2 flex-items-center">
      ...
      <ul class="dropdown-menu dropdown-menu-sw">
        ...
        <li><!-- '"` --><!-- </textarea></xmp> --></option></form><form class="logout-form" action="/logout" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="&#x2713;" /><input type="hidden" name="authenticity_token" value="mdw7AYAxGF2k7p6HUJx+Y8UB5kJn7RIQ8boNZW8GIQOpbWsprqBCiL2z1sJZSC7VCcdHA3/FijLzh3k+jgECWw==" />
        ...
        <!-- '"` --><!-- </textarea></xmp> --></option></form><form class="sr-only right-0" action="/logout" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="&#x2713;" /><input type="hidden" name="authenticity_token" value="ZjWiBmB2pdOV7Ts4+H04ABdOYeflMQA6BNi+p+xqQ/FWhPIuTuf/Boywc33xqWi224jApv0ZmBgG5cr8DW1gqQ==" />
          <button type="submit" class="dropdown-item dropdown-signout" data-ga-click="Header, sign out, icon:logout">
            Sign out
          </button>
</form>      </div>
  ...
  <li>
        <!-- '"` --><!-- </textarea></xmp> --></option></form><form data-autosubmit="true" data-remote="true" class="js-social-container" action="/notifications/subscribe" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="&#x2713;" /><input type="hidden" name="authenticity_token" value="XZXp1SjsXMum3m0kZyKLu34+WR2K/PBEX0xlM9cgNjomRWPq93jlQdQ53Jis5zmg34Sfh60kax0xw9T+mpiCnQ==" />      <input type="hidden" name="repository_id" id="repository_id" value="91845262" class="form-control" />
  ...
  <div class="js-toggler-container js-social-container starring-container ">
    <!-- '"` --><!-- </textarea></xmp> --></option></form><form class="starred js-social-form" action="/asmotiwale/DSTL_Sattelite_Image_Object_Classification/unstar" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="&#x2713;" /><input type="hidden" name="authenticity_token" value="r1GTOPc0G6RFGcxqH2sG2ZMrkDZtWierqCGXFlDBFkhzyIxNIh+qH11ULCX3zRf3NqdJFsAmkC9az9myHOj8iQ==" />
    ...
    <!-- '"` --><!-- </textarea></xmp> --></option></form><form class="unstarred js-social-form" action="/asmotiwale/DSTL_Sattelite_Image_Object_Classification/star" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="&#x2713;" /><input type="hidden" name="authenticity_token" value="QTg77NVEa5dxmiNmOo7Qe84O+Ch9SAw089qbkw7F3tpMAL5Igl3gJaKtg0wo0bBJbj4fC+dpP6GVbmppzWcZWA==" />
      <input type="hidden" name="context" value="repository"></input>
      <button
        type="submit"
        class="btn btn-sm btn-with-count js-toggler-target"
  ...
  <li>
          <!-- '"` --><!-- </textarea></xmp> --></option></form><form class="btn-with-count" action="/asmotiwale/DSTL_Sattelite_Image_Object_Classification/fork" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="&#x2713;" /><input type="hidden" name="authenticity_token" value="fF39cgI3zikkkZ4E9OMB0rcm1+tmmPOAh/8TAU7OyHMN77hUTaG8XSFYAjbtB3FgIHP4EsdKZN6d7yeXI6EMSg==" />
            <button
                type="submit"
...
<div class="container new-discussion-timeline experiment-repo-nav  ">
  ...
  <a class="d-none js-permalink-shortcut" data-hotkey="y" href="/asmotiwale/DSTL_Sattelite_Image_Object_Classification/blob/3e9bd02335077bce2631ac49d3b641deb14d5e41/code/createGrids.py">Permalink</a>

  <!-- blob contrib key: blob_contributors:v21:9eb7460a6cf6656f62b25437b147ac68 -->
...
<div class="select-menu branch-select-menu js-menu-container js-select-menu float-left">
      ...
      <div class="select-menu-list select-menu-tab-bucket js-select-menu-tab-bucket" data-tab-filter="branches" role="menu">
        ...
        <div data-filterable-for="context-commitish-filter-field" data-filterable-type="substring">
            ...
            <a class="select-menu-item js-navigation-item js-navigation-open selected"
               href="/asmotiwale/DSTL_Sattelite_Image_Object_Classification/blob/master/code/createGrids.py"
               data-name="master"
               data-skip-pjax="true"
               rel="nofollow">
              <svg class="octicon octicon-check select-menu-item-icon" viewBox="0 0 12 16" version="1.1" width="12" height="16" aria-hidden="true"><path fill-rule="evenodd" d="M12 5l-8 8-4-4 1.5-1.5L4 10l6.5-6.5z"/></svg>
  ...
  <div class="file-actions">
    ...
    <div class="BtnGroup">
      <a id="raw-url" class="btn btn-sm BtnGroup-item" href="/asmotiwale/DSTL_Sattelite_Image_Object_Classification/raw/master/code/createGrids.py">Raw</a>
        <a class="btn btn-sm js-update-url-with-hash BtnGroup-item" data-hotkey="b" href="/asmotiwale/DSTL_Sattelite_Image_Object_Classification/blame/master/code/createGrids.py">Blame</a>
      <a rel="nofollow" class="btn btn-sm BtnGroup-item" href="/asmotiwale/DSTL_Sattelite_Image_Object_Classification/commits/master/code/createGrids.py">History</a>
    </div>
        ...
        <a class="btn-octicon tooltipped tooltipped-nw"
          ...
          <!-- '"` --><!-- </textarea></xmp> --></option></form><form class="inline-form js-update-url-with-hash" action="/asmotiwale/DSTL_Sattelite_Image_Object_Classification/edit/master/code/createGrids.py" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="&#x2713;" /><input type="hidden" name="authenticity_token" value="o6HgWDthUPoi1fQRbhb54tlk0EwZltAAsbZ0jpFDZM2muMVnYyxqDP8P/m50FlwJl3llJXcaMd7BiDHwjQ8oEQ==" />
            <button class="btn-octicon tooltipped tooltipped-nw" type="submit"
              aria-label="Fork this project and edit the file" data-hotkey="e" data-disable-with>
              <svg class="octicon octicon-pencil" viewBox="0 0 14 16" version="1.1" width="14" height="16" aria-hidden="true"><path fill-rule="evenodd" d="M0 12v3h3l8-8-3-3-8 8zm3 2H1v-2h1v1h1v1zm10.3-9.3L12 6 9 3l1.3-1.3a.996.996 0 0 1 1.41 0l1.59 1.59c.39.39.39 1.02 0 1.41z"/></svg>
            </button>
</form>
        <!-- '"` --><!-- </textarea></xmp> --></option></form><form class="inline-form" action="/asmotiwale/DSTL_Sattelite_Image_Object_Classification/delete/master/code/createGrids.py" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="&#x2713;" /><input type="hidden" name="authenticity_token" value="zEy02bGkRPVfJYr6WKCnY11fUU8emNell2xg/G7l8zEcI2+qHeNBG97hAZxGUW1s4kQmwYSThs2ukbsRV2l/jQ==" />
  ...
  <div itemprop="text" class="blob-wrapper data type-python">
      ...
      <tr>
        ...
        <td id="LC3" class="blob-code blob-code-inner js-file-line"><span class="pl-k">import</span> tifffile <span class="pl-k">as</span> tiff</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC7" class="blob-code blob-code-inner js-file-line"><span class="pl-k">def</span> <span class="pl-en">createMask</span>(<span class="pl-smi">image_shape</span>):</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC9" class="blob-code blob-code-inner js-file-line">	<span class="pl-c"><span class="pl-c">#</span># Image Dimensions</span></td>
      </tr>
      <tr>
        <td id="L10" class="blob-num js-line-number" data-line-number="10"></td>
        <td id="LC10" class="blob-code blob-code-inner js-file-line">	refXLength <span class="pl-k">=</span> <span class="pl-c1">834</span></td>
      </tr>
      <tr>
        <td id="L11" class="blob-num js-line-number" data-line-number="11"></td>
        <td id="LC11" class="blob-code blob-code-inner js-file-line">	refYLength <span class="pl-k">=</span> <span class="pl-c1">830</span></td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC13" class="blob-code blob-code-inner js-file-line">	<span class="pl-c"><span class="pl-c">#</span># Grid dimensions</span></td>
      </tr>
      <tr>
        <td id="L14" class="blob-num js-line-number" data-line-number="14"></td>
        <td id="LC14" class="blob-code blob-code-inner js-file-line">	gridXLen <span class="pl-k">=</span> <span class="pl-c1">round</span>(<span class="pl-c1">30</span> <span class="pl-k">*</span> image_shape[<span class="pl-c1">0</span>]<span class="pl-k">/</span>refXLength)</td>
      </tr>
      <tr>
        <td id="L15" class="blob-num js-line-number" data-line-number="15"></td>
        <td id="LC15" class="blob-code blob-code-inner js-file-line">	gridYLen <span class="pl-k">=</span> <span class="pl-c1">round</span>(<span class="pl-c1">30</span> <span class="pl-k">*</span> image_shape[<span class="pl-c1">1</span>]<span class="pl-k">/</span>refYLength)</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC17" class="blob-code blob-code-inner js-file-line">	<span class="pl-c"><span class="pl-c">#</span> print(&quot;CreateMask() :&quot;)</span></td>
      </tr>
      <tr>
        <td id="L18" class="blob-num js-line-number" data-line-number="18"></td>
        <td id="LC18" class="blob-code blob-code-inner js-file-line">	<span class="pl-c"><span class="pl-c">#</span> print(gridXLen)</span></td>
      </tr>
      <tr>
        <td id="L19" class="blob-num js-line-number" data-line-number="19"></td>
        <td id="LC19" class="blob-code blob-code-inner js-file-line">	<span class="pl-c"><span class="pl-c">#</span> print(gridYLen)</span></td>
      </tr>
      <tr>
        <td id="L20" class="blob-num js-line-number" data-line-number="20"></td>
        <td id="LC20" class="blob-code blob-code-inner js-file-line">	<span class="pl-c"><span class="pl-c">#</span> print(&quot;-----------------&quot;)</span></td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC22" class="blob-code blob-code-inner js-file-line">	gridMask <span class="pl-k">=</span> np.zeros((image_shape[<span class="pl-c1">0</span>], image_shape[<span class="pl-c1">1</span>]))</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC24" class="blob-code blob-code-inner js-file-line">	numGridsX <span class="pl-k">=</span> math.ceil(image_shape[<span class="pl-c1">0</span>]<span class="pl-k">/</span>gridXLen)</td>
      </tr>
      <tr>
        <td id="L25" class="blob-num js-line-number" data-line-number="25"></td>
        <td id="LC25" class="blob-code blob-code-inner js-file-line">	<span class="pl-k">for</span> x <span class="pl-k">in</span> <span class="pl-c1">range</span>(<span class="pl-c1">0</span>, image_shape[<span class="pl-c1">0</span>]):</td>
      </tr>
      <tr>
        <td id="L26" class="blob-num js-line-number" data-line-number="26"></td>
        <td id="LC26" class="blob-code blob-code-inner js-file-line">		<span class="pl-k">for</span> y <span class="pl-k">in</span> <span class="pl-c1">range</span>(<span class="pl-c1">0</span>, image_shape[<span class="pl-c1">1</span>]):</td>
      </tr>
      <tr>
        <td id="L27" class="blob-num js-line-number" data-line-number="27"></td>
        <td id="LC27" class="blob-code blob-code-inner js-file-line">			gridMask[x][y] <span class="pl-k">=</span> (x<span class="pl-k">//</span>gridXLen<span class="pl-k">+</span><span class="pl-c1">1</span>) <span class="pl-k">+</span> numGridsX<span class="pl-k">*</span>(y<span class="pl-k">//</span>gridYLen) </td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC29" class="blob-code blob-code-inner js-file-line">	<span class="pl-k">return</span> gridMask</td>
      </tr>
      <tr>
  ...
  <div class="BlobToolbar position-absolute js-file-line-actions dropdown js-menu-container js-select-menu d-none" aria-hidden="true">
    ...
    <div class="dropdown-menu-content js-menu-content" id="inline-file-actions">
      <ul class="BlobToolbar-dropdown dropdown-menu dropdown-menu-se mt-2">
        ...
        <li><a class="dropdown-item js-update-url-with-hash" id="js-view-git-blame" href="/asmotiwale/DSTL_Sattelite_Image_Object_Classification/blame/3e9bd02335077bce2631ac49d3b641deb14d5e41/code/createGrids.py">View git blame</a></li>
...
<div class="footer container-lg px-3" role="contentinfo">
  <div class="position-relative d-flex flex-justify-between pt-6 pb-2 mt-6 f6 text-gray border-top border-gray-light ">
    <ul class="list-style-none d-flex flex-wrap ">
      <li class="mr-3">&copy; 2018 <span title="0.38383s from unicorn-1778634166-4d2mj">GitHub</span>, Inc.</li>
